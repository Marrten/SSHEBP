    ...
    <body>
        <div id="login_dialog" class="panel panel-success">
            ...
            <div style="background-color:#ffffff;margin:10px;" class="panel-body">
                <form action="ebp/Login" method="post">                              
                    <ul class="reg-box">
                    	<span style="color: red;"><s:actionerror/></span>
                        <li>
                            <label for="">用户名</label><input type="text" name="username" placeholder="请输入您的用户名" value="${ formbean.username}" class="account" maxlength="11" style="color:#999;" onBlur="textBlur(this)" onFocus="textFocus(this)"/>
                            <span class="error error5">
                    		</span>
                        ...
                        <li>
                            <label for="">密    码</label><input type="password" name="password" class = "admin_pwd" value="${ formbean.password}" placeholder="请输入密码" style="color:#999;" onBlur="textBlur(this)" onFocus="textFocus(this)"/>
                            <span class="error error6">
                    		</span>
                        </li>
                        <font color='red' size="-1" id="usernames"><i>
                    				<s:fielderror>	
                        ...
                        <li>
                            ...
                            <span><img src="ebp/AuthCode" class="codes" onclick="reflush(this)"></span>
                    ...
                    <a href="ebp/register.jsp" style="float:right;">免费注册</a>                  
                </form>
            </div>
        </div>
    </body>
