			...
			<div class="panel-heading">
				...
				<form method="post" action="admin/FindBook">
					<div class="input-group">
						...
						<input class="btn btn-info" type="submit" name="bookname">搜索
						</span>
					</div>
				</form>
				</div>
		   	   	    ...
		   	   	    <c:choose>
	   	   	    		...
	   	   	    		<li class="list-group-item">
		   	   	    		   ...
		   	   	    		   <div class="manager-button">
		   	   	    		   	 <a  href="admin/loadBook.jsp?id=${book.id}" class="change-btn btn btn-info">修改</a>
		   	   	    		   	   <a  href="admin/DeleteBook?id=${book.id}" class="btn btn-info ">下架</a>
		   	   	    		   </div>
		   	   	    		   </c:when>
		   	   	    		   <c:otherwise>
		   	   	    		   	 	<h1>查无此书</h1>
