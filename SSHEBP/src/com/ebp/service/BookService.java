...
public class BookService {
	 ...
	 * @throws BookExistsExecption
	 */
	public PageBean<Book> getBooksByCategoryId(QueryBean queryBean, int category_id) throws BookExistsExecption {
		// 获取用户订单
		QueryResult<Book> queryResult = bookDAO.getBooksByCategoryId(queryBean, category_id);
